...
INSTALLED_APPS = [
    ...
    "graphene_django",
    "django_filters", #Đức thêm
    "graphene_file_upload",  # Thêm để support file upload trong GraphQL
    "SHOEX.chatbot", 
    "SHOEX.users",     
    "SHOEX.store",     # Thêm app store
    "SHOEX.products",   
    "SHOEX.collection", # Thêm app collection
    "SHOEX.cart",      # Thêm app cart
    "SHOEX.orders",    
    "SHOEX.payments",   
    "SHOEX.shipments",
    "SHOEX.reviews",
...
ROOT_URLCONF = 'SHOEX.config.urls'
...
WSGI_APPLICATION = 'SHOEX.config.wsgi.application'
